...
export const articles = writable([
  {
    id: 588287967474,
    title: 'Welcome to Digital Nomadland',
    created_at: '2022-12-17T01:14:37-05:00',
    body_html:
      '<p><span class="lead-in-text-callout">Seen from afar,</span> the parish of Ponta do Sol looks as compact and picturesque as a postcard. Theres a small roundabout at the center, a gas station, a tiny shopping complex, and a cluster of modest buildings topped by terra-cotta roof tiles. Rippling green slopes of banana, palm, and pine fan out behind, houses dotted among the hills. All of this is surrounded by dramatic escarpment and made subtropically lush by the many small waterfalls that gurgle from the rock face, filling centuries-old irrigation canals. When Gonçalo Hall first drove through the area in September 2020, the words that came into his mind were: “What the fuck is this.”</p>\n<p class="paywall">Ponta do Sol is on the southern coast of Madeira, the main island of the Portuguese archipelago of the same name. Hall had visited Madeira once as a kid, but he didnt remember it being so beautiful, so wild. Now, as he put it in an interview, he was seeing the place “with the eyes of a digital nomad.” He had returned to help run a conference about remote work in Madeiras regional capital, Funchal. The day after his long drive through the countryside, he approached the regional secretary of economy and asked point-blank: Why are you sleeping on digital nomads?</p>',
    blog_id: 89021022450,
    author: 'Jacob Keil',
    user_id: 85945614578,
    published_at: '2022-12-17T01:14:37-05:00',
    updated_at: '2022-12-17T01:40:21-05:00',
    summary_html:
    ...
    template_suffix: '',
    handle: 'welcome-to-digital-nomadland',
    tags: 'Article, Tech',
    admin_graphql_api_id: 'gid://shopify/OnlineStoreArticle/588287967474',
    image: {
      created_at: '2022-12-17T01:40:21-05:00',
      alt: '',
      width: 1600,
      height: 2399,
      src: 'https://cdn.shopify.com/s/files/1/0665/0449/1250/articles/KJ_WiredMagazine_03_Revised_Backchannel.webp?v=1671259221'
    }
  },
  {
    id: 588042797298,
    ...
    body_html:
      '<p>In the past 10 years, theres been an explosion of places to buy glasses online. Rather than head to a department store or specialty eyewear shop, you can find pretty much any style of prescription or non-prescription glasses you want online.</p>\n<p>GlassesUSA was one of the early players in the direct-to-consumer eyewear game, and theyve done a good job of making a specific niche for themselves.</p>\n<p>I went ahead and ordered a pair of glasses from them to see how their system works, and in this GlassesUSA review, Ill share my pros and cons to using their service before giving a final verdict on whether theyre worth buying from.</p>',
    blog_id: 89021022450,
    author: 'Jacob Keil',
    user_id: 85945614578,
    ...
    summary_html:
      'On the plus side, GlassesUSA has a deep catalog of name brands. This is a great place to start if youre looking for a pair of glasses with some street cred.',
    template_suffix: '',
  ...
  },
  {
    ...
    body_html:
      'Lily is a local Tampa artist who specializes in contemporary Japanese murals and history.',
    blog_id: 89130664178,
    author: 'Jacob Keil',
    user_id: 85945614578,
  ...
  },
  {
    ...
    body_html:
      '<p>The coats in this article should keep you warm enough in places like New York and the Midwest, but if youre living in a place that experiences extremely cold temperatures, you may only benefit from suggestion #1 during your coldest days.</p>\n<p>If youre in, say, northern Minnesota, it might not be a great idea to wear a quilted jacket over a T-shirt on the coldest day of winter. But most of these coats will be fine with multiple layers on those non-record breaking days.</p>\n<p>So now that weve absolved ourselves of the responsibility for any fashionable hypothermia, lets dive into our four favorite winter coats!</p>',
    blog_id: 89021022450,
    author: 'Jacob Keil',
    user_id: 85945614578,
    ...
    summary_html:
      'Yes, if youve got the right winter coats, its actually<em> so </em>easy to look great all season long.',
    template_suffix: '',
  ...
  },
  {
    ...
    body_html:
      '<div class="has-content-area" data-url="https://seths.blog/2022/10/product-idea-talking-discs/" data-title="Product idea: Talking discs" data-hashtags="" title="Product idea: Talking discs">\n<p>Many offices and public settings are putting up clear plexiglass barriers to insulate staff from the spread of disease. While we can easily see through these partitions, it ends up creating a lot of yelling.</p>\n<p>What if there were a disc, about the size of a hockey puck and the thickness of a few coasters… it would come in pairs, be low-powered and Bluetooth enabled. Stick one on one side of the glass, one on the other. Its a microphone and a speaker… boom. At scale, theyd probably be really cheap.</p>\n<p>One extension: allow the disc to also hook up to a wifi router or laptop. Now, you can have a disc at your home office and your colleague can have one too. Tap it to turn it on, and if the other person chooses to unmute, you can have a casual conversation the way we might in the old office-bound days.</p>\n<p>Its pretty easy to imagine creating a simple app that could record and create a transcript of every transaction, which could be useful for bureaucracies and public records.</p>\n<p>Another extension: Integrate it with real-time translation and now the disk allows you to talk to anyone in any language…</p>\n</div>',
    blog_id: 89021022450,
    author: 'Jacob Keil',
    user_id: 85945614578,
  ...
  },
  {
    ...
    summary_html:
      'Getting this knot right can be done in ten easy steps, so weve broken the process down in simple steps. Take some time to practice this knot, and youll be tying the Half Windsor Knot like a pro!',
    template_suffix: '',
